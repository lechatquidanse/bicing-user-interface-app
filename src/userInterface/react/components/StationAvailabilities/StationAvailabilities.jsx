    ...
    <div>
      ...
      <FilterWithDateRangeAndSelect
        ...
        onDateStartChange={(date) => {
          ...
          onDateChange(stationId, byIntervalInPeriodFilter(date, dateEnd, interval));
        }}
        onDateEndChange={(date) => {
          onDateEndPicked(date);
          onDateChange(stationId, byIntervalInPeriodFilter(dateStart, date, interval));
        }}
        onOptionChange={(selectedOption) => {
          onIntervalSelected(selectedOption);
          onIntervalChange(stationId, byIntervalInPeriodFilter(dateStart, dateEnd, selectedOption));
        }}
      />
